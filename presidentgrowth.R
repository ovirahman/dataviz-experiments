...
text(bp[data$growth>0],-0.3, label = paste0(data$growth[data$growth>0], "M"), pos = 3, cex = 0.8, col = "white")
text(bp[data$growth<0],-1.4, label = paste0(data$growth[data$growth<0], "M"), pos = 3, cex = 0.8, col = "white")
text(bp[data$growth>0],-1.8, label = data$president[data$growth>0], pos = 3, cex = 1)
text(bp[data$growth<0],0, label = data$president[data$growth<0], pos = 3, cex = 1)

#abline(h = 20, lty = 2, col = rgb(0,0,0,0.1))
text(1,20, label = "20 MILLION", cex = 0.8)
text(1,10, label = "10 MILLION" , cex = 0.8)
text(1,-5, label = "-5 MILLION" , cex = 0.8)
...
text(8,26, label = "Job growth by president", cex = 2.5)
text(3,-8,label = "Source: Federal Reserve Bank of St. Louis, \"All Employees, Total Nonfarm\" via facebook.com/barackobama/", cex = 0.6)
